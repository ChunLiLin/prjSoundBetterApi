...
namespace prjSoundBetterApi.Controllers
{
    public class TProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FProjectId,FMemberId,FName,FBudget,FStartdate,FEnddate,FDescription,FProjectStatusId,FSiteId,FThumbnailPath")] TProject tProject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FProjectId,FMemberId,FName,FBudget,FStartdate,FEnddate,FDescription,FProjectStatusId,FSiteId,FThumbnailPath")] TProject tProject)
        {
